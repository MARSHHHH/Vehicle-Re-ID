...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_dir', default='.\VeRi\pytorch', type=str, help='./test_data')
    parser.add_argument('--name', default='ft_ResNet50', type=str, help='save model path')
    parser.add_argument('--batchsize', default=34, type=int, help='batchsize')
    parser.add_argument('--linear_num', default=256, type=int, help='feature dimension: 512 or default or 0 (linear=False)')
